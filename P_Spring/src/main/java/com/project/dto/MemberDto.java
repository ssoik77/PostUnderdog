...
public class MemberDto {
    ...
    private String e_name; // 이름 필드 추가

    public MemberDto(Boolean a_authority, Boolean p_authority, Boolean e_authority, String m_id, String m_pw, Integer m_key, String e_name) {

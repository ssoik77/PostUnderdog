...
const Find = () => {
    ...
    const sendFindIdData = async (e) => {
        ...
        try {
            const response = await axios.post(`${API_URL}/find/id`, findData);
    ...
    const sendFindPwData = async (e) => {
        ...
        try {
            const response = await axios.post(`${API_URL}/find/pw`, findData);
        ...
        <div id={styles.idpwFindPage}>
            <div id={styles.idpwFindBox}>
                ...
                <div id={styles.findIdForm} style={isIdFormOpen}>
                    ...
                    {isModalOpen && (
                        <div className={styles.idpwFindResultBox}>
                        { modalContent }
                        </div>
                    )}

                    {!isModalOpen && (
                        <form className={styles.formBox} onSubmit={sendFindIdData}>
                            <label>이름</label>
                ...
                <div id={styles.findPwForm} style={isPwFormOpen}>
                    ...
                    {!isModalOpen && (
                        <form className={styles.formBox} onSubmit={sendFindPwData}>
                            <label>아이디</label>

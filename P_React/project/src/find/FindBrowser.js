...
import styles from './FindBrowser.module.css'; // CSS 모듈 파일
                ...
                <div id={styles.findIdForm} style={isIdFormOpen}>
                    ...
                    {!isModalOpen && (
                        <form onSubmit={sendFindIdData}>
                            ...
                            <button id={styles.idFormButton} type="submit">아이디 찾기</button>
                        </form>
                    )}
                ...
                <div id={styles.findPwForm} style={isPwFormOpen}>
                    ...
                    {!isModalOpen && (
                        <form onSubmit={sendFindPwData}>
                            ...
                            <button id={styles.pwFormButton} type="submit">비밀번호 찾기</button>
                        </form>
                    )}

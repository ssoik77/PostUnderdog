        ...
        <table id={styles.employeeList}>
            <thead>
                <tr>
                    ...
                    <th id={styles.titlec} className={styles.columnTitle}>Birth</th>
                    <th id={styles.titled} className={styles.columnTitle}>Phone</th>
                    <th id={styles.titlee} className={styles.columnTitle}>Status</th>
